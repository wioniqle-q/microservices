...
public sealed class UserModelAssesment : UserDeriveModel
{
...
public class UserDeriveModel
{
    public UserDeriveModel() { }

    public UserDeriveModel(Object? userId, string? userName, string? firstName, string? middleName, string? lastName, string? email, string? password)
    {
        UserId = userId;
        UserName = userName;
        FirstName = firstName;
